...
const config: Config = {
  ...
  url: 'https://gemini-ros2-textbook.github.io',
  ...
  organizationName: 'gemini-ros2-textbook', // Usually your GitHub org/user name.
  projectName: 'ros2-textbook', // Usually your repo name.
